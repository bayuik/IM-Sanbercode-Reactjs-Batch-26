        ...
        <div style={{ border: "1px solid #aaa", padding: "10px", marginBottom: '20px' }}>
          ...
          >
            <Form.Item label="Name" style={{ fontWeight: "bold" }}>
              <Input
                placeholder="PUBG, Valorant, ..."
                type="text"
                name="name"
                value={games !== null && games.name}
                onChange={handleChange}
              />
            </Form.Item>
            <Form.Item label="Platform" style={{ fontWeight: "bold" }}>
              <Input
                placeholder="Mobile, PC, ..."
                type="text"
                name="platform"
                value={games !== null && games.platform}
                onChange={handleChange}
              />
            </Form.Item>
            <Form.Item label="Genre" style={{ fontWeight: "bold" }}>
              <Input
                placeholder="Video Game, Battle Royal, ..."
                type="text"
                name="genre"
                value={games !== null && games.genre}
                onChange={handleChange}
              />
            </Form.Item>
            <Form.Item label="Release" style={{ fontWeight: "bold" }}>
              <Input
                ...
                max={2021}
                min={1980}
                value={games !== null && games.release}
                onChange={handleChange}
              />
            </Form.Item>
            <Form.Item label="Single Player" style={{ fontWeight: "bold" }}>
              <Select
                placeholder={
                  games !== null && games.singlePlayer === 1 ? "Yes" : "No"
                }
            ...
            <Form.Item label="Multi Player" style={{ fontWeight: "bold" }}>
              <Select
                placeholder={
                  games !== null && games.multiplayer === 1 ? "Yes" : "No"
                }
            ...
            <Form.Item label="Image URL" style={{ fontWeight: "bold" }}>
              <Input.TextArea
                ...
                rows="3"
                name="image_url"
                value={games !== null && games.image_url}
                onChange={handleChange}
              />
            </Form.Item>
